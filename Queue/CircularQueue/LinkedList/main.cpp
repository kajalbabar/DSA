/* This is driver Program used to call the all functions of the stack
 * queue.h: contain the defination of Queue class
 * method.h: contain all defination of the class's methods
 * node.h: contain the structure of the node which is used to create the node
 */
...
int main(){
        ...
        //object created to call all the funtionality of the queue
        Queue queue;
